...
<!-- hidden fields (ikut ke form #data_form yang ada di index) -->
<input type="hidden" id="id" name="id" value="<?= $id; ?>">
<input type="hidden" id="code_lv4" name="code_lv4" value="<?= $code_lv4; ?>">


<div class="form-group row mb-3">
	<div class="col-md-2"><label>Material ID</label></div>
	<div class="col-md-10">
...
<div class="form-group row mb-3">
	<div class="col-md-2"><label>Material Master</label></div>
	<div class="col-md-10">
...
<div class="form-group row mb-3">
	...
	<div class="col-md-5"><span class="text-red text-bold">Lower Price</span></div>
	<div class="col-md-5"><span class="text-green text-bold">Higher Price</span></div>
</div>

<div class="form-group row mb-3">
	<div class="col-md-2"><label>Before</label></div>
...
<div class="form-group row mb-3">
	<div class="col-md-2"><label>After</label></div>
...
<div class="form-group row mb-3">
	<div class="col-md-2"></div>
	<div class="col-md-5"><span class="text-red text-bold">Before</span></div>
	<div class="col-md-5"><span class="text-green text-bold">After</span></div>
</div>

<div class="form-group row mb-3">
	<div class="col-md-2"><label>Price Reference</label></div>
	...
	<div class="col-md-5">
		<div class="input-group">
			<span class="input-group-text">IDR</span>
			<input type="text" class="form-control text-center autoNumeric" id="price_ref_use_after" name="price_ref_use_after" value="<?= $price_ref_high_new; ?>" required>
			<span class="input-group-text">USD</span>
			<input type="text" class="form-control text-center autoNumeric6" id="price_ref_use_after_usd" name="price_ref_use_after_usd" value="<?= $price_ref_high_new_usd; ?>" required>
		</div>
	</div>
</div>

<div class="form-group row mb-3">
	<div class="col-md-2"><label>Expired Reference</label></div>
	<div class="col-md-5">
		<input type="text" class="form-control" id="tgl_expired_use" name="tgl_expired_use" value="<?= $tgl_expired_use; ?>" readonly>
	</div>
	<div class="col-md-5">
		<select id="price_ref_expired_use_after" name="price_ref_expired_use_after" class="form-control chosen-select" required>
...
<div class="form-group row mb-3">
	...
	<div class="col-md-2"><label>Kurs</label></div>
	<div class="col-md-3">
		<input type="text" class="form-control text-center autoNumeric" id="kurs" name="kurs" value="<?= $kurs; ?>" readonly>
	</div>
</div>
...
<div class="form-group row mb-3">
	...
	<div class="col-md-10">
		<select id="action_app" name="action_app" class="form-control chosen-select" required>
...
<div class="form-group row mb-3">
	...
	<div class="col-md-10">
		<textarea class="form-control" id="status_reject" name="status_reject" rows="3" placeholder="Reason"></textarea>
	</div>
</div>