<?php
$ENABLE_ADD     = has_permission('Master_coating.Add');
$ENABLE_MANAGE  = has_permission('Master_coating.Manage');
$ENABLE_VIEW    = has_permission('Master_coating.View');
$ENABLE_DELETE  = has_permission('Master_coating.Delete');
...
<div class="form-group row mb-3">
	<div class="col-md-3">
		<label for="nama" class="form-label mb-0">Coating Name <span class="text-danger">*</span></label>
	</div>
	<div class="col-md-9">
