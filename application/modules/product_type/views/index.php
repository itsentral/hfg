        ...
        <div class="modal-content">
            <form id="data_form" autocomplete="off">
                <div class="modal-header">
                    <h4 class="modal-title" id="head_title">Product Type</h4>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on('click', '.add', function () {
            ...
            $("#head_title").html(`${title} Product Type`);
            ...
            swal({
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        if (res.status == '1') {
                            swal({ title: "Success", text: res.pesan, type: "success" },
                    ...
                    error: function () {
                        swal({ title: "Error", text: "Error Process!", type: "error" });
                    }
                });
            });
        });
