...
<div class="req_payment_inc">
    <hr class="mt-2">
    <h3>Receive Invoice by Incoming Checked</h3>
    <div class="row">
        ...
        <table class="table table-bordered table_req_pay_inc">
            ...
            <tbody>
                ...
                foreach ($list_inc as $item) {
                    ...
                    $status = '<div class="badge rounded-pill bg-warning">Belum Lunas</div>';
                    // if($id_rec_invoice !== ''){
                    ...
                    if (count($get_invoice_payment) > 0) {
                        ...
                        if (count($check_payment_approve) > 0) {
                            $status = '<div class="badge rounded-pill bg-success">Lunas</div>';
                            $complete = 1;
                        }
                    }
