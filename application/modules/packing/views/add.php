...
<div class="form-group row mb-3">
	<div class="col-md-3">
		<label for="nama" class="form-label mb-0">Packing Name <span class="text-danger">*</span></label>
	</div>
	<div class="col-md-9">
		<input type="text" class="form-control" id="nama" name="nama" required placeholder="Packing Name" value="<?= $nama; ?>">
	</div>
</div>