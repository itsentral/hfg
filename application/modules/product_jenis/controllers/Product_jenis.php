...
class Product_jenis extends Admin_Controller
{
    ...
    public function add($id=null){	
      ...
      if($this->input->post()){
        ...
        $this->db->trans_start();
          if(empty($id)){
            $this->db->insert('product_lvl_3',$dataProcess);
          }
          else{
            $this->db->where('id',$id);
            $this->db->update('product_lvl_3',$dataProcess);
          }
        ...
        $listData = $this->db->get_where('product_lvl_3',array('id' => $id))->result();
      ...
      $this->db->trans_begin();
      $this->db->where('id',$id)->update("product_lvl_3",$data);
