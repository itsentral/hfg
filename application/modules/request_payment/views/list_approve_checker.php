            ...
            <div class="row col-md-12 mb-3">
                <div class="col-md-2 col-sm-6">
                    <div class="panel panel-metric">
                        ...
                        <div class="panel-footer">
                            <button type="button" class="btn btn-icon-edit btn-sm btn_view_req" data-val="transportasi">
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="panel panel-metric">
                        ...
                        <div class="panel-footer">
                            <button type="button" class="btn btn-icon-edit btn-sm btn_view_req" data-val="kasbon">
                                <i class="fa fa-eye"></i> View
                            </button>
                        </div>
                    </div>
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="panel panel-metric">
                        <div class="panel-heading bg-blue">
                            <div class="heading-wrap">
                                <i class="fas fa-hand-holding-usd heading-icon"></i>
                                <span>Expense</span>
                            </div>
                        </div>
                        <div class="panel-body">
                        ...
                        <div class="panel-footer">
                            <button type="button" class="btn btn-icon-edit btn-sm btn_view_req" data-val="expense">
                                <i class="fa fa-eye"></i> View
                            </button>
                        </div>
                    </div>
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="panel panel-metric">
                        ...
                        <div class="panel-footer">
                            <button type="button" class="btn btn-icon-edit btn-sm btn_view_req" data-val="periodik">
                                <i class="fa fa-eye"></i> View
                            </button>
                        </div>
                    </div>
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="panel panel-metric">
                        ...
                        <div class="panel-footer">
                            <button type="button" class="btn btn-icon-edit btn-sm btn_view_req" data-val="pembayaran_po">
                                <i class="fa fa-eye"></i> View
                            </button>
                        </div>
                    </div>
                ...
                <div class="col-md-2 col-sm-6">
                    <div class="panel panel-metric">
                        ...
                        <div class="panel-footer">
                            <button type="button" class="btn btn-icon-edit btn-sm btn_view_req" data-val="direct_payment">
                                <i class="fa fa-eye"></i> View
                            </button>
                        </div>
                    </div>
