		...
		<div class="card-body">
			...
			<div class="col-md-12">
				<div class="form-group row">
					...
					<div class="col-md-4">
						<button type="button" class="btn btn-md btn-danger" onclick="reject_req_payment()"><i class="fa fa-close"></i> Reject</button>
						<button type="submit" name="save" class="btn btn-success btn-md" id="submit"><i class="fa fa-save">&nbsp;</i>Update</button>
					</div>
				</div>
			</div>
		</div>
